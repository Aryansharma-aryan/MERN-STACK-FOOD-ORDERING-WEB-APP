...
const AdminDashboard = () => {
  ...
  const fetchFoods = async () => {
    try {
      const response = await axios.get("http://localhost:3100/api/food"); // Correct API endpoint
  ...
  const handleAddFood = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("http://localhost:3100/api/addFood", newFood); // Correct API endpoint
  ...
  const handleDeleteFood = async (foodId) => {
    try {
      const response = await axios.delete(`http://localhost:3100/api/food/${foodId}`); // Correct API endpoint
      alert(response.data.message);
  ...
  const handleUpdateFood = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.put(`http://localhost:3100/api/food/${editingFood._id}`, newFood); // Correct API endpoint
      alert(response.data.message);
