...
const {signup, login, addFood, addBulk, getPayments,getFood, order, getOrder,deleteOrder,validateSignup, validateLogin,createOrder, verifyPayment  } = require("../controller/authController"); 
